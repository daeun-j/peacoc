...
def get_fedavg_argparser() -> ArgumentParser:
    ...
    parser.add_argument("-fe", "--finetune_epoch", type=int, default=2)
    parser.add_argument("-tg", "--test_gap", type=int, default=1)
    parser.add_argument("-ee", "--eval_test", type=int, default=1)
    parser.add_argument("-ev", "--eval_val", type=int, default=1)
    parser.add_argument("-er", "--eval_train", type=int, default=1)
    parser.add_argument("-lr", "--local_lr", type=float, default=1e-1)
    parser.add_argument("-mom", "--momentum", type=float, default=0.9)
    parser.add_argument("-wd", "--weight_decay", type=float, default=5e-4)
    parser.add_argument("-vg", "--verbose_gap", type=int, default=5)
    ...
    parser.add_argument("-pj", type = str, default = 'test')
